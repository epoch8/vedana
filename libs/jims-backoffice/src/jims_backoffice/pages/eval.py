            ...
            rx.hstack(
                ...
                rx.tooltip(
                    rx.button(
                        ...
                        size="1",
                        variant="ghost",
                        on_click=state_cls.export_tests_xlsx,
                        flex_shrink="0",
                    ),
                    content="Export .xlsx",
                ),
            ...
            rx.vstack(
                ...
                rx.hstack(
                    rx.button(
                        ...
                        f"Export {state_cls.compare_run_label_a} .xlsx",
                        size="1",
                        variant="soft",
                        on_click=state_cls.export_compare_a_xlsx,
                    ),
                    rx.button(
                        rx.icon("download", size=13),
                        f"Export {state_cls.compare_run_label_b} .xlsx",
                        size="1",
                        variant="soft",
                        on_click=state_cls.export_compare_b_xlsx,
                    ),
                    rx.spacer(),
