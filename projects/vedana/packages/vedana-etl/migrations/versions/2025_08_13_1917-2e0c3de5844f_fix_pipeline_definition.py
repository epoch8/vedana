...
def upgrade() -> None:
    ...
    op.create_table('prepare_edges_d5fc9dd5c0_meta',
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('prepare_edges_c225902fe6_meta',
    ...
    sa.PrimaryKeyConstraint('from_node_id', 'to_node_id', 'edge_label', name=op.f('prepare_edges_c225902fe6_meta_pkey'))
    )
