...
memgraph_steps = [
    ...
    # TODO use precompiled table to accept new branches easily
    # Todo process embeddings reliably and efficiently

    BatchTransform(
        func=steps.sync_memgraph_nodes,
        inputs=["api_nodes", "grist_nodes_filtered", "memgraph_vector_indexes"],
    ...
    BatchTransform(
        func=steps.sync_memgraph_edges,
        inputs=["api_edges", "related_products", "grist_edges_filtered", "memgraph_vector_indexes"],
